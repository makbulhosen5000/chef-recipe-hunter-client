    ...
    <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 my-10 ms-12">
      <div>
        ...
        <p>
          ...
          is handled by the DOM itself. To write an uncontrolled component,
          instead of writing an event handler for every state update, you can
        ...
        <p>
          ...
          React's built-in hooks or other custom hooks to encapsulate reusable
          logic. Custom hooks allow you to abstract away complex logic and share
          it across multiple components, promoting code reusability and making
      ...
      <div>
        ...
        <p>
          ...
          JavaScript. It provides a vast set of built-in modules and libraries,
          making it suitable for building scalable network applications,
          real-time applications, microservices, and more.
        </p>
        <p>
          Express.js is a web application framework for Node.js. It provides a
          lightweight, flexible, and minimalist approach to building web
